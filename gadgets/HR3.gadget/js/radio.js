...
var radioText   = "HR3";
var radioUrl    = "https://www.hr3.de";                                  // Homepage

var streamUrl   = "https://dispatcher.rndfnk.com/hr/hr3/live/mp3/high";  // Stream Adresse

var scraperUrl1 = "https://scraper.onlineradiobox.com/";                 // Scraper Basis Adresse
var scraperUrl2 = "de.hr3radio";                                         // Scraper Adresse

var cover = "images/hr3.png";  // Wird angezeigt, wenn kein Cover verfügbar ist
...
function swapDock(){
  ...
  if (System.Gadget.docked) {       // Gadget Docked = normale Größe
    offset_Width = 115;             // Offset in Pixel, ab dem der Text rotiert/gescrollt wird
    with (document.body.style) {
      width =130;
      height=73;
      backgroundImage = "url('images/Docked.png')";
      backgroundColor = "#C20014";
    }  
  ...
  if (req.readyState == 4) {
    if (req.status == 200) {
      ...
      if (str.indexOf('iImg":') > -1) {
        ...
        cover = "images/hr3.png";  // Wird angezeigt, wenn kein Cover verfügbar ist
      }
